...
const getActiveClasses = () => {
 const activeClasses = classes.filter(cls => cls.active === true )
const activePeople = activeClasses.map(cls => getPeopleOfClass(cls.name) )
